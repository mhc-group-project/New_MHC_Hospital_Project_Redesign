...
1.FAQ -the admin can list, create, uodate,delete and also ulist a particular faq from a category
2.FAQ Categories - The public user can view the list of Faq category and can view all the faqs listed under that category.The admin user has full CRUD acces.
